...
public interface FocusTypeRepository extends JpaRepository<FocusType, Long> {
    ...
    List<FocusType> findByUserIdAndDelFlag(String userId, String delFlag);

    List<FocusType> findByUserIdOrderBySequenceAsc(String userId);

    boolean existsByUserIdAndDefaultFlag(String userId, String defaultFlag);
    ...
    @Query("""
        ...
        ORDER BY 
            ...
            f.sequence ASC
        """)
    List<FocusType> findCustomFocusTypes(@Param("userId") String userId);
